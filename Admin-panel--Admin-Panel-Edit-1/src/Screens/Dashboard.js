...
import { AiFillDashboard, AiOutlineUser, AiFillShopping, AiFillCaretRight } from 'react-icons/ai';
        ...
        <div className="rightSideContainer">
          ...
          <div className="UpperPart">
            <div>
              <p className="UnderHeaderText">
                Welcome {currentUser.firstname} {currentUser.lastname}, everything looks great
              </p>
            </div>
            <div className="NotificationBell">
              ...
              <PopupState variant="popover" popupId="demo-popup-popover">
                {(popupState) => (
                  <>
                    <div style={{ width: 120, marginLeft: 'auto' }} {...bindTrigger(popupState)}>
                      <Badge
                    ...
                    <Popover
                      ...
                      <div>
                        {allNotifications.map((n) => {
                          return <SingleNotification userId={n.refOfUser} notificationId={n._id} />;
                        })}
                      </div>
                    </Popover>
                  </>
          ...
          <div class="row">
            ...
            <div style={{ padding: '0px' }} class="col-xl-3 col-md-6 col-sm-12">
              <div className="boxForInfo">
                <div className="boxForInfoUpperContainer">
                  <p className="boxNumber">{getProductsFromBackend.data.result}</p>
            ...
            <div className="Graphs">
              ...
              <div className="PieGraph">
                <Chart options={options2} series={series2} type="pie" width={'80%'} />
              </div>
            </div>
          </div>
        </div>
